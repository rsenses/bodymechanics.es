/* Wednesday 10th of May 2017 12:22:14 PM*/
    ...
    return (
        (e.addTest = function (a, b) {
            if (typeof a == 'object') for (var d in a) y(a, d) && e.addTest(d, a[d]);
                ...
                a = a.toLowerCase();
                if (e[a] !== c) return e;
                (b = typeof b == 'function' ? b() : b), typeof f != 'undefined' && f && (g.className += ' nextend-' + (b ? '' : 'no-') + a), (e[a] = b);
            }
            return e;
        }),
        z(''),
        ...
        (g.className = g.className.replace(/(^|\s)no-js(\s|$)/, '$1$2') + (f ? ' nextend-js nextend-' + t.join(' nextend-') : '')),
        e
    );
})(this, this.document)),
    (function (a, b, c) {
...
window.jQuery = typeof jQuery == 'undefined' ? null : jQuery;
...
function version_compare(e, t, n) {
    ...
    var r = 0,
        i = 0,
        s = 0,
        o = { dev: -6, alpha: -5, a: -5, beta: -4, b: -4, RC: -3, rc: -3, '#': -2, p: 1, pl: 1 },
        u = function (e) {
            e = ('' + e).replace(/[_\-+]/g, '.');
...
(function () {
    var tmp = window.jQuery ? jQuery : null;
...
(function ($) {
    ...
    var eventNames = ['transitionend', 'webkitTransitionEnd', 'otransitionend', 'oTransitionEnd'];
        ...
        toString: function (use3d) {
            ...
            for (var i in this) {
                if (this.hasOwnProperty(i)) {
                    ...
                    if (!support.transform3d && (i === 'rotateX' || i === 'rotateY' || i === 'rotateZ' || i === 'perspective' || i === 'transformOrigin')) {
                        continue;
                    }
    ...
    $.fn.transitionStop = $.fn.transitStop = function (clearQueue, jumpToEnd) {
        this.each(function () {
            ...
            if (properties) {
                ...
                if (jumpToEnd) {
                    for (var i = 0; i < properties.length; i++) this.style[properties[i]] = css[properties[i]];
...
(function ($, scope, undefined) {
    scope.ssAnimation = NClass.extend({
        ...
        init: function (layer, options) {
            ...
            if (!this.canvas) this.canvas = this.layer;
            if (this.layer.animated === undefined) this.layer.animated = false;
            this.options = $.extend(
                {
                    easingIn: 'linear',
                    easingOut: 'linear',
        ...
        _initAnimation: function () {
            ...
            this.layer
                .on('ssanimateinstart.ssdefault', function (event) {
        ...
        _canAnimate: function () {
            if (this.layer.animated) return false;
    ...
    if (scope.ssAnimationManager === undefined) scope.ssAnimationManager = new scope.ssAnimationManagerClass();
})(jQuery, window);
(function ($, scope, undefined) {
    var methods = {
    ...
    scope.ssTypeBase = NClass.extend({
        ...
        afterInit: function () {
            ...
            for (var i = 0; i < this.slideList.length; i++) {
                ...
                this.slideList
                    .eq(i)
                    .on('incrementanimation.ssanimation', function () {
                        this.ssanimation++;
                    })
                ...
                $(this).on('load.first', function () {
                    ...
                    var show = function () {
                        ...
                        if (_this.options.playfirstlayer) {
                            ...
                            canvas
                                .on('ssanimationsended.first', function () {
        ...
        changeTo: function (i, reversed, autoplay) {
            if (window.ssadmin || i === this._active || this._animating) return false;
        ...
        animateOut: function (i, reversed) {
            ...
            $slide
                .on('ssanimationsended.ssmainanimateout', function () {
        ...
        animateIn: function (i, reversed) {
            ...
            var motion = ssAnimationManager.getAnimation('no', $slide);
            $slide
                .on('ssanimationsended.ssmainanimatein', function () {
        ...
        initAutoplay: function () {
            ...
            if (autoplay.resumeautoplay.slideplayed) {
                this.$slider.on('ssplayended', function () {
                    if (!_this.autoplayTimer) _this.reStartAutoPlay();
                });
            }
        ...
        deviceType: function () {
            ...
            return ua.match(/GoogleTV|SmartTV|Internet.TV|NetCast|NETTV|AppleTV|boxee|Kylo|Roku|DLNADOC|CE\-HTML/i)
                ...
                ? 'desktop'
                : // tablet
                ua.match(/iPad/i) || (ua.match(/tablet/i) && !ua.match(/tablet pc/i) && !ua.match(/RX-34/i)) || ua.match(/FOLIO/i)
                ? 'tablet'
                : // android tablet
                ua.match(/Linux/i) && ua.match(/Android/i) && !ua.match(/Fennec|mobi|HTC.Magic|HTCX06HT|Nexus.One|SC-02B|fone.945/i)
                ? 'tablet'
                : // Kindle or Kindle Fire
                ua.match(/Kindle/i) || (ua.match(/Mac.OS/i) && ua.match(/Silk/i))
                ? 'tablet'
                : // pre Android 3.0 Tablet
                ua.match(/GT-P10|SC-01C|SHW-M180S|SGH-T849|SCH-I800|SHW-M180L|SPH-P100|SGH-I987|zt180|HTC(.Flyer|\_Flyer)|Sprint.ATP51|ViewPad7|pandigital(sprnova|nova)|Ideos.S7|Dell.Streak.7|Advent.Vega|A101IT|A70BHT|MID7015|Next2|nook/i) || (ua.match(/MB511/i) && ua.match(/RUTEM/i))
                ? 'tablet'
                : // unique Mobile User Agent
                ua.match(/BOLT|Fennec|Iris|Maemo|Minimo|Mobi|mowser|NetFront|Novarra|Prism|RX-34|Skyfire|Tear|XV6875|XV6975|Google.Wireless.Transcoder/i)
                ? 'mobile'
                : // odd Opera User Agent - http://goo.gl/nK90K
                ua.match(/Opera/i) && ua.match(/Windows.NT.5/i) && ua.match(/HTC|Xda|Mini|Vario|SAMSUNG\-GT\-i8000|SAMSUNG\-SGH\-i9/i)
                ? 'mobile'
                : // Windows Desktop
                ...
                ua.match(/Bot|Crawler|Spider|Yahoo|ia_archiver|Covario-IDS|findlinks|DataparkSearch|larbin|Mediapartners-Google|NG-Search|Snappy|Teoma|Jeeves|TinEye/i) && !ua.match(/Mobile/i)
                ? 'desktop'
                : 'desktop';
        },
        randomize: function () {
...
(function ($, scope, undefined) {
    scope.ssAnimationSlide = scope.ssAnimation.extend({
        ...
        _setOutStart: function () {
            this.layer
                .css('left', this.layer[0].origLeftPercent + '%')
        ...
        _animate: function (coords, startVisibility, startDisplay, endDisplay, cssclass, interval, easing, delay, endfn) {
            ...
            this.layer
                ...
                .css('left', left + coords.origX)
                .css('top', top + coords.origY)
                .css('visibility', startVisibility)
                .css('display', startDisplay);
            ...
            this.timeout = setTimeout(function () {
                ...
                if (nModernizr.csstransitions && animation && animation.length > 0) {
                    for (var i = 0; i < animation.length; i++) {
                        layer.css('visibility', 'visible').transition(animation[i].css, (interval * (animation[i].percent - percent)) / 100, easing);
                        percent = animation[i].percent;
                    }
                }
                layer.data('sstransit', endfn);
                layer.css('visibility', 'visible').transition(endcss, (interval * (100 - percent)) / 100, easing, function () {
                    $this.layer.css('display', endDisplay).removeClass(cssclass);
                    $this[endfn]();
                });
            }, 50 + parseInt(delay));
...
(function ($, scope, undefined) {
    scope.ssSimpleSlider = scope.ssTypeBase.extend({
        ...
        sizeInited: function () {
            if (jQuery('#' + this.id + ' .nextend-flux img').length != this.slideList.length) this.options.flux[0] = 0;
                    ...
                    swipeStatus: function (event, phase, direction, distance, duration, fingers) {
                        ...
                        if (_this.options.touchanimation == 'horizontal') {
                            ...
                            if (direction == 'up') {
                                ...
                                _this.slideList
                                    .eq(next)
                                    .css('top', _this.slideDimension.h - distance)
                                    .css('left', '0') /*.css('display', 'block')*/;
